...
> **Legacy snapshot.** This file describes the pre-LangGraph Hermes design and is not an architectural source of truth. Use [`README.md`](README.md) and the routed current contracts.
