...
3. [`backend/artifacts.md`](backend/artifacts.md) - production truth and typed references.
4. [`agents/README.md`](agents/README.md) - creative capability catalog.
5. [`backend/pipeline.md`](backend/pipeline.md) and [`pipelines/`](pipelines/) - pipeline topology.
6. [`tools/tools.md`](tools/tools.md) - controlled side effects.
7. [`rag/architecture.md`](rag/architecture.md) - knowledge, chunks, retrieval, context injection.
...
- Direct/FTS retrieval first; add one evaluated hybrid vector index only when it improves the gold set.
