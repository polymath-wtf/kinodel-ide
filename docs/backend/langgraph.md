...
Use the official documentation and installed-version source in the optional ignored `.reference/langgraph` checkout, plus local [fundamentals](../../skills/LangGraph/langgraph-fundamentals/SKILL.md), [HITL](../../skills/LangGraph/langgraph-human-in-the-loop/SKILL.md), and [persistence](../../skills/LangGraph/langgraph-persistence/SKILL.md). Upstream examples do not prove application-level idempotency, local installation or recovery. Actual checks are in [Local MVP](../roadmap-mvp.md#acceptance).
