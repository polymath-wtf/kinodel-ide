...
If you wish to use LLM assistance for generating longer prompts, check out [base krea agent](krea-base-agent.md) and use it as a system prompt for LLM of your choice.
